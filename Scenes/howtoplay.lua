...
function scene:show( event )
	...
	if ( phase == "will" ) then
		...
		local secondtext = display.newText( sceneGroup, "There will be ten waves per level where enemies will come at your city", 350, 270, system.NativeFont, 20)
		secondtext:setFillColor( 1,1,0 )
		local thirdtext = display.newText( sceneGroup, "You must create and upgrade towers in order defend your city", 350, 290, system.NativeFont, 20)
		local fourthtext = display.newText( sceneGroup, "from the invading ships", 350, 310, system.NativeFont, 20 )
		fourthtext:setFillColor( 1,1,0 )
		thirdtext:setFillColor( 1,1,0 )
		local fifthtext = display.newText( sceneGroup, "You can place towers by tapping on the asteroids", 350, 330,  system.NativeFont, 25)
		fifthtext:setFillColor( 1,1,0 )
		local sixthtext = display.newText( sceneGroup, "and then choose the tower you desire", 350, 350, system.NativeFont, 25 )
		sixthtext:setFillColor(1,1,0)
		local seventhtext = display.newText( sceneGroup, "After the ten waves end or at any other time you can click the menu ", 350, 370, system.NativeFont, 20 )
		seventhtext:setFillColor( 1,1,0 )
		local eighthtext = display.newText( sceneGroup, "button at the top right to move back to the main menu and select another level", 350, 390, system.NativeFont, 20 )
		eighthtext:setFillColor( 1,1, 0 )
	--	local ninthtext = display.newText( sceneGroup, , x, y, [width, height,], font, fontSize )
		...
		local enemyonedesc = display.newText( sceneGroup, "Striker class ship", 375, 475, system.NativeFont, 25)
		local enemyonedescpt2 = display.newText( sceneGroup, "Health:240", 375, 500, system.NativeFont, 25)
		local enemyonedescpt3 = display.newText( sceneGroup, "Speed:400", 375, 525, system.NativeFont, 25)
		...
		local enemytwodescpt5 = display.newText( sceneGroup, "Value: 50", 375, 725, system.NativeFont, 25)
		...
		local enemythreedescpt5 = display.newText( sceneGroup, "Value: 150", 375, 925, system.NativeFont, 25)
